  ...
  <div class="flex flex-wrap ml-20">
    ...
    <el-card class="width-400 height-full">
      ...
      <div class="mt-10 pl-5 pt-5 pr-5 pb-5">
        <div>
          <span class="orange">isString</span><span class="blue">('测试字符串')</span> -> true
        </div>
        <div class="mt-10">
          <span class="orange">isString</span><span class="blue">(true) </span> -> false
        </div>
      </div>
    </el-card>
    <!-- 截取字符串(stringSplit) -->
    <el-card class="width-400 height-full ml-20">
      <div class="fs-16 fw-600 tomato">
        截取字符串(stringSplit)
        <el-icon class="hover-pointer" @click="copyUtils('stringSplit')">
          <DocumentCopy />
        </el-icon>
      </div>
      <div class="mt-10">
        共三个参数<br />参数1:目标字符；<br />参数2:以什么为分割；<br />参数3:分割后的目标下标
      </div>
      <div class="mt-10 pl-5 pt-5 pr-5 pb-5">
        <div>
