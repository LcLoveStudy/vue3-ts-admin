<template>
  <div class="document">
    ...
    <div class="mt-25">
      ...
      <span class="tomato bgc-lightgray">(避免和flex使用，当使用flex布局后会立刻请求网络)</span><br />
      <span class="fs-20 mt-20 inline-block">用法说明:</span><br />
      在图片过多的地方使用v-lazy指令,进行图片懒加载，当往下滚动页面时,图片进入视线后才会发送请求<span
        class="tomato bgc-lightgray">(只适用于请求服务器的图片，项目assets文件夹中的不可用)</span><br />
  ...
  <el-card class="page_main width-800 height-800 overflow-y-auto ">
    <img v-lazy="'https://img2.baidu.com/it/u=2098302066,1207295454&fm=253&fmt=auto&app=138&f=JPEG?w=562&h=343'">
    <img v-lazy="'https://img1.baidu.com/it/u=2676533820,1803958359&fm=253&fmt=auto&app=138&f=JPEG?w=600&h=400'">
    <img v-lazy="'https://img2.baidu.com/it/u=3196968309,1319515521&fm=253&fmt=auto&app=138&f=PNG?w=751&h=500'">
