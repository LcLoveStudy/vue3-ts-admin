<template>
  <autoRadio v-model:value="value" :option="[{ label: '你好', value: 'good' }, { label: '不好', value: 'bad' }]"
    @change="change" />
  <autoRadio type="checkbox" v-model:value="value"
    :option="[{ label: '你好', value: 'good' }, { label: '不好', value: 'bad' }]" @change="change" />
  <RichEditor class="mt-20" v-model:value="inputValue" @change="inputChange" />
</template>
